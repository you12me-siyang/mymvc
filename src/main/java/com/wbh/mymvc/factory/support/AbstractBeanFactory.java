...
public abstract class AbstractBeanFactory implements WebContextBeanFactory {

	private final Map<String, BeanDefinition> beanDefinitionMap = new ConcurrentHashMap<String, BeanDefinition>();
	private final Map<String, Object> beanInstantiationMap = new ConcurrentHashMap<String, Object>();
	private final Map<String, Object> beanFactoryDataMap = new ConcurrentHashMap<String, Object>();
				...
				for (String str : bd.getConfigurables().keySet()) {
					for (Field f : fs) {
						...
						if (str.equals(f.getName())) {
							...
							case "int":
								f.set(o, Integer.parseInt((String) bd
										.getConfigurables().get(str)));
								break;
							case "string":
								f.set(o, (String) bd.getConfigurables()
										.get(str));
								break;
							case "boolean":
								f.set(o, Boolean.parseBoolean((String) bd
										.getConfigurables().get(str)));
								break;
							case "float":
								f.set(o, Float.parseFloat((String) bd
										.getConfigurables().get(str)));
								break;
							case "long":
								f.set(o, Long.parseLong((String) bd
										.getConfigurables().get(str)));
								break;
							default:
								;
	...
	public Map<String, Object> getBeanFactoryDataMap() {
		return beanFactoryDataMap;
	}
